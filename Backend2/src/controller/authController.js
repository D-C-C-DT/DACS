...
const register = async (req, res) => {
    try {
        ...
        const transporter = nodemailer.createTransport({
            service: 'Gmail',
            auth: {
                user: 'duotchicuong@gmail.com', // Email của bạn
                pass: 'ecnz xuya yeug brzz', // Mật khẩu email
            },
        });

        const mailOptions = {
            from: 'duotchicuong@gmail.com',
            to: email,
...
const forgotPassword = async (req, res) => {
    try {
        ...
        const transporter = nodemailer.createTransport({
            service: 'Gmail',
            auth: {
                user: 'duotchicuong@gmail.com',
                pass: 'ecnz xuya yeug brzz',
            },
        });
